...
export function Jobs() {
    ...
    async function fetchAllJobDescriptions() {
        const response = await axios.get('http://localhost:5000/jobs/descriptions');
            ...
            <FormControl style={{marginLeft: "5%", width: '25%' }} >
                ...
                >
                    ...
                    {jobDescriptions.map((jobDescription) => (
                        <MenuItem value={jobDescription.ONetDescription}>{jobDescription.ONetDescription}</MenuItem>))}
                </Select>
            </FormControl>
